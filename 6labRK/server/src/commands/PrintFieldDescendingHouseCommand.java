...
public class PrintFieldDescendingHouseCommand extends Command{
    ...
    public PrintFieldDescendingHouseCommand(FlatCollectionManager collectionManager) {
        super("print_field_descending_house", "print from the collection field house in descending order", CommandAccess.NORMAL, CommandType.NON_ARGUMENT);
