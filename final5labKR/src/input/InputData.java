...
public class InputData {
    ...
    public InputData(FlatCollectionManager collection){
    ...
    public int readId() throws InputException {
        for (; ; ) {
            System.out.println("Enter id : ");
            String number = scanner.nextLine();
            try {
                int id = Integer.parseInt(number);
                if(!collection.getIds().contains(id))throw new InputException("No such id");
                return id;
            } catch (NumberFormatException exception) {
            }
        }
